 ...
 *v1.5.0: 2021/10/20
 *  Added new logic for melee weapons
 *  Added Regeneration Shots
 *  Fixed unlock rank of some consumables
 *v1.4.0: 2021/10/19
 *  Added new functionality: Price Limit
 *  Fixed html tags in Randomizer.html
 *v1.3.3: 2021/10/17
...
function getRandomTools(numberOfTools, weaponMelee = melee.NORMAL) {
    ...
    var getMelee = () => {
        ...
        if (availableMeleeTools && availableMeleeTools.length > 0) {
            ...
            if (randomMelee) {
                //delete all melee weapons from filter list after one is found.
