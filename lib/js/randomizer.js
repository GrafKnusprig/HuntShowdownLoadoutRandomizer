...
function appendAmmo(weapon, ammoId1, ammoId2, sumCost)
{
		...
		if(randomAmmo1 != null)
		{
			...
			$(ammoId1).append('<li><div class="ammo-title">' + randomAmmo1.name + '</div><img width="100" src="images/items/' + randomAmmo1ImageName + '.webp"/></li>');
		}
		else
		{
		...
		if(randomAmmo2 != null)
		{
			...
			$(ammoId2).append('<li><div class="ammo-title">' + randomAmmo2.name + '</div><img width="100" src="images/items/' + randomAmmo2ImageName + '.webp"/></li>');
		}
		else
		{
